classdef PIDlookahead
    ...
    methods
        ...
        function [vR, vL, obj] = update(obj, coord, mouse, linha, dt, sensores, boost, tipo_ld)
            ...
            repulsion_gain = 1.0;
            centering_gain = 5.0; % Ganho para centralização entre paredes
            ...
            if left_wall_detected && right_wall_detected
                ...
                if dist_esq < wall_thresh
                    %fprintf("Muito perto!");
                    corr_wall = corr_wall + repulsion_gain * (wall_thresh - dist_esq);
                end
                if dist_dir < wall_thresh
                    %fprintf("Muito perto!");
                    corr_wall = corr_wall - repulsion_gain * (wall_thresh - dist_dir);
                end
            end
            ...
            % Calcular curvatura no ponto alvo
